...
Status: preserved implementation and acceptance specification. Product choices
remain authoritative in [PLAN.md](../PLAN.md). The runtime and acceptance suite
now exist; [implementation status](implementation-status.md) records what shipped
and where the current interface differs from this design-stage chapter.
