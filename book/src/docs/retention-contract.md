...
The release includes a maintained
[maintenance service](https://github.com/marshallr12/agent_coordinator/blob/main/deploy/agent-coordinator-maintenance.service)
and
[daily timer](https://github.com/marshallr12/agent_coordinator/blob/main/deploy/agent-coordinator-maintenance.timer).
Install them
